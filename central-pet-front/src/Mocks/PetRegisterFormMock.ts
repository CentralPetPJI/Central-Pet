...
export const petRegisterFormSchema = z.object({
  ...
  species: z.enum(['dog', 'cat'], 'Selecione uma especie valida.'),
  breed: z.string().trim().min(1, 'Informe a raca do pet.'),
  sex: z.enum(['Femea', 'Macho'], 'Selecione um sexo valido.'),
  size: z.enum(['Pequeno', 'Medio', 'Grande'], 'Selecione um porte valido.'),
